...
class MonParcellaire:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'MonParcellaire_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&MonParcellaire')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('MonParcellaire', message)
    ...
    def onClosePlugin(self):
        ...
        print("** Fermeture MonParcellaire")
    ...
    def unload(self):
        ...
        #print "** UNLOAD MonParcellaire"

        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&MonParcellaire'),
                action)
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = MonParcellaireDockWidget()
